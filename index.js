  ...
  geocoder.geocode({
    ...
    if (status == 'OK') {
      ...
      var contentString = '<div id="content">' +
        ...
        address +
        '<br><a href="https://maps.google.com/maps?saddr=' + results_obj.formatted_address + '" target="_blank">Get Directions</a>' +
        '</div>';
...
app.controller('libraryFilters', function($scope, $http) {
  $http.get('https://raw.githubusercontent.com/mimikim/Baltimore-City-Library-Locations/master/libraries.json').then(function(response) {
